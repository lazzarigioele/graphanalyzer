...
**Note:** if you installed `graphanalyzer.py` without using conda, then you will probably need to launch the script like this:

    python ./your/path/graphanalyzer.py ...
